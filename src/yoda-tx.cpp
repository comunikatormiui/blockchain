...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Yoda Core yoda-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  yoda-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded yoda transaction") + "\n" +
                               "  yoda-tx [options] -create [commands]   " + _("Create hex-encoded yoda transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded yoda transaction
