...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* YODA features */
        {"yoda", "listmasternodes", &listmasternodes, true, true, false},
        {"yoda", "getmasternodecount", &getmasternodecount, true, true, false},
        {"yoda", "masternodeconnect", &masternodeconnect, true, true, false},
        {"yoda", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"yoda", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"yoda", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"yoda", "masternodecurrent", &masternodecurrent, true, true, false},
        {"yoda", "masternodedebug", &masternodedebug, true, true, false},
        {"yoda", "startmasternode", &startmasternode, true, true, false},
        {"yoda", "createmasternodekey", &createmasternodekey, true, true, false},
        {"yoda", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"yoda", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"yoda", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"yoda", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"yoda", "getmasternodescores", &getmasternodescores, true, true, false},
        {"yoda", "preparebudget", &preparebudget, true, true, false},
        {"yoda", "submitbudget", &submitbudget, true, true, false},
        {"yoda", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"yoda", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"yoda", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"yoda", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"yoda", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"yoda", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"yoda", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"yoda", "checkbudgets", &checkbudgets, true, true, false},
        {"yoda", "mnsync", &mnsync, true, true, false},
        {"yoda", "spork", &spork, true, true, false},
        {"yoda", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> yoda-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51463/\n";
}
