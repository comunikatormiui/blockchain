...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4,           // ONLY_NONDENOMINATED and not 10000 YODA at the same time
    ONLY_10000 = 5,                                 // find masternode outputs including locked ones (use with caution)
    STAKEABLE_COINS = 6                             // UTXO's that are valid for staking
};

// Possible states for zYODA send
...
public:
    ...
    /// Get 10000 YODA output and keys which can be used for the Masternode
    ...
    // zYODA wallet
    CzYODAWallet* zwalletMain;
    std::unique_ptr<CzYODATracker> zpivTracker;
    void setZWallet(CzYODAWallet* zwallet);
    CzYODAWallet* getZWallet();
    ...
    // zYODA reset
    boost::signals2::signal<void()> NotifyzYODAReset;
};
