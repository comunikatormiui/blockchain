...
#include "qt/yoda/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/yoda/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(YODAGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the YODA RPC console.") + "<br>" +
