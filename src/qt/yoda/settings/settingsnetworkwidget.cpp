...
#include "qt/yoda/settings/settingsnetworkwidget.h"
#include "qt/yoda/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/yoda/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(YODAGUI* _window, QWidget *parent) :
