...
#include "qt/yoda/settings/forms/ui_settingsmainoptionswidget.h"
#include "QListView"
...
SettingsMainOptionsWidget::SettingsMainOptionsWidget(YODAGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsMainOptionsWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Customize the application window options"));
    ...
    // Switch
    ui->pushSwitchStart->setText(tr("Start YODA on system login"));
