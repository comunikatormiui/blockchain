...
#include "qt/yoda/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/yoda/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(YODAGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to YODAGUI::handleRestart()
