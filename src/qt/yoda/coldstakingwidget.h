...
#include "qt/yoda/furabstractlistitemdelegate.h"
#include "qt/yoda/txviewholder.h"
#include "qt/yoda/tooltipmenu.h"
#include "qt/yoda/sendmultirow.h"
#include "qt/yoda/coldstakingmodel.h"
#include "qt/yoda/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(YODAGUI* parent);
    ~ColdStakingWidget();
