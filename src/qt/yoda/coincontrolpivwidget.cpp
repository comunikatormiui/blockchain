...
#include "qt/yoda/coincontrolpivwidget.h"
#include "qt/yoda/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText(tr("Select YODA Outputs to Spend"));
    ...
    ui->labelTitleAmount->setText("YODA");
    ...
    ui->labelValueAfter->setText("0.00 YODA");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 YODA");
    ui->labelValueFee->setText("0.00 YODA");
