...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, YODAGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, YODAGUI *gui, double posX = 3);
