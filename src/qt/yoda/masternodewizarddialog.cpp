...
#include "qt/yoda/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 51462");
    ...
    if(walletModel->isTestNetwork()){
        ...
        ui->lineEditPort->setText("51464");
    } else {
        ui->lineEditPort->setText("51462");
    }
