...
#include "qt/yoda/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/yoda/lockunlock.h"
#include "qt/yoda/qtutils.h"
#include "qt/yoda/receivedialog.h"
...
TopBar::TopBar(YODAGUI* _mainWindow, QWidget *parent) :
...
void TopBar::updateBalances(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance,
    ...
    // Update display state and/or values for zYODA balances as necessary
    bool fHaveZerocoins = zerocoinBalance > 0;

    // Set visibility of zYODA label titles/values
