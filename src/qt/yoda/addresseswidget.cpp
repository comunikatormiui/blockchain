...
#include "qt/yoda/forms/ui_addresseswidget.h"
#include "qt/yoda/addresslabelrow.h"
...
AddressesWidget::AddressesWidget(YODAGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter YODA address"));
