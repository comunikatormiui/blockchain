...
#include "qt/yoda/forms/ui_receivewidget.h"
...
#include "qt/yoda/addressholder.h"
...
ReceiveWidget::ReceiveWidget(YODAGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive YODA."));
