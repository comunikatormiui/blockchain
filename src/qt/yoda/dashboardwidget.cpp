...
#include "qt/yoda/dashboardwidget.h"
#include "qt/yoda/forms/ui_dashboardwidget.h"
#include "qt/yoda/sendconfirmdialog.h"
#include "qt/yoda/txrow.h"
...
DashboardWidget::DashboardWidget(YODAGUI* parent) :
    PWidget(parent),
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of YODA and zYODA staked."));
    ...
    ui->labelAmountZpiv->setText("0 zYODA");
    ui->labelAmountPiv->setText("0 YODA");
    ...
    ui->comboBoxSort->addItem(tr("Date desc"), SortTx::DATE_DESC);
    ui->comboBoxSort->addItem(tr("Date asc"), SortTx::DATE_ASC);
    ui->comboBoxSort->addItem(tr("Amount desc"), SortTx::AMOUNT_ASC);
    ui->comboBoxSort->addItem(tr("Amount asc"), SortTx::AMOUNT_DESC);
    ...
    ui->btnHowTo->setText(tr("How to get YODA or zYODA"));
...
void DashboardWidget::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("YODA")
    updateDisplayUnit();
}
...
void DashboardWidget::changeChartColors(){
    ...
    if(isLightTheme()){
        ...
        gridLineColorX = QColor(13, 37, 76);
        linePenColorY =  gridLineColorX;
        backgroundColor = linePenColorY;
    }
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair YODA, zYODA
...
void DashboardWidget::onChartRefreshed() {
    ...
    // init sets
    set0 = new QBarSet("YODA");
    set1 = new QBarSet("zYODA");
    set0->setColor(QColor(12,37,77));
    set1->setColor(QColor(13,80,139));
