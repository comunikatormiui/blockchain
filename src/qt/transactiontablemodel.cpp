...
// Copyright (c) 2016-2020 The YODA developers
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("YODA Stake");
    case TransactionRecord::StakeZPIV:
        return tr("zYODA Stake");
    case TransactionRecord::StakeDelegated:
        return tr("YODA Cold Stake");
    case TransactionRecord::StakeHot:
        return tr("YODA Stake on behalf of");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted YODA to zYODA");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zYODA");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received YODA from zYODA");
    case TransactionRecord::ZerocoinSpend_Change_zPiv:
        return tr("Minted Change as zYODA from zYODA Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zYODA to YODA");
    default:
        return QString();
    }
}
