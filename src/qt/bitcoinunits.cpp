...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(YODA);
    unitlist.append(mYODA);
    unitlist.append(uYODA);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case YODA:
        return QString("yoda");
    case mYODA:
        return QString("myoda");
    case uYODA:
        return QString::fromUtf8("uyoda");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit, bool isZpiv)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case YODA:
            return z + QString("YODA");
        case mYODA:
            return z + QString("mYODA");
        case uYODA:
            return z + QString::fromUtf8("μYODA");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case YODA:
            return z + QString("tYODA");
        case mYODA:
            return z + QString("mtYODA");
        case uYODA:
            return z + QString::fromUtf8("μtYODA");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case YODA:
            return QString("YODA");
        case mYODA:
            return QString("Milli-YODA (1 / 1" THIN_SP_UTF8 "000)");
        case uYODA:
            return QString("Micro-YODA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
