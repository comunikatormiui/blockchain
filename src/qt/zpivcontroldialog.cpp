// Copyright (c) 2017-2020 The YODA developers
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zYODA Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zYODA.";
            else if (!mint.isSeedCorrect)
                strReason = "The zYODA seed used to mint this zYODA is not the same as currently hold in the wallet";
            else
