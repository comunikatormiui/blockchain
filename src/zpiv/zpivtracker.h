...
#ifndef YODA_ZPIVTRACKER_H
#define YODA_ZPIVTRACKER_H
...
public:
    CzYODATracker(std::string strWalletFile);
    ~CzYODATracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzYODAWallet* zYODAWallet = NULL);
